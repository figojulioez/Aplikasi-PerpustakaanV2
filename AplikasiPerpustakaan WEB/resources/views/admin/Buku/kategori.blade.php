...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
  ...
  <div class="w3-container d-flex justify-content-start w-100">
   <div class="w-50">
    <form method="post" action="/pendataan-buku/kategori" enctype="multipart/form-data">
      @csrf
      <div class="mb-3">
        <label for="exampleFormControlInput1" class="form-label"><b>Nama Kategori</b></label>
        <input autocomplete="off" required type="text" class="form-control" id="exampleFormControlInput1" placeholder="Kategori  ..." name="kategori">
      </div>
