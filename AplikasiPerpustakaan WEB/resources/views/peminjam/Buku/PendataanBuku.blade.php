              ...
              <table class="table table-bordered mt-4 text-center">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    @if($cek == 0 )
                    <td><a href="pinjam/{{ $buku->bukuId }}" class="btn btn-warning pinjam">Pinjam</a></td>
                    @endIf  
                </tr>
                  @endForeach
                </tbody>
              ...
              <table class="table table-bordered mt-4 text-center">
                ...
                <tbody>
                  ...
                  <!-- <td class="d-flex justify-content-between">
                    ...
                    <a class="btn btn-danger delete" href="#" data-bs-toggle="modal" data-delete="{{ $kategori->kategoriId }}" data-bs-target="#exampleModal2"><i class="fa-solid fa-trash"></i></a>
                  </td> -->
                </tr>
                  @endForeach
                </tbody>
